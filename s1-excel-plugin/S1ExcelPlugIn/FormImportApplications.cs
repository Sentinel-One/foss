...
{
    public partial class FormImportApplications : Form
    {
        ...
        int UpdateInterval = Globals.ApplicationBatch;
        ...
        public FormImportApplications()
        {
            ...
            try
            {
                ...
                string appBatch = crypto.GetSettings("ExcelPlugIn", "ApplicationBatch");

                if (appBatch == null)
                {
                    crypto.SetSettings("ExcelPlugIn", "ApplicationBatch", UpdateInterval.ToString());
                }
                else
                {
                    UpdateInterval = Convert.ToInt32(appBatch);
                }
            }
            catch (Exception ex)
            {
